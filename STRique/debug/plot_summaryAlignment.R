...
PLOT_PATH="/Users/gianlucadamaggio/projects/cattaneo/debug/plots/"

final_df=read.table("/Users/gianlucadamaggio/projects/cattaneo/docs/20200813/alignment/summary/alignment_summary_qscore-7.txt", header=T,sep='\t')

final_df$qscore="7"

for ( qscore in c(7.5, 8, 8.5, 9, 9.5, 10, 13)) {

QSCORE= qscore
#DATAFRAME = paste("myd_", QSCORE , sep="")

filePath=paste("/Users/gianlucadamaggio/projects/cattaneo/docs/20200813/alignment/summary/alignment_summary_qscore-", QSCORE ,".txt", sep="")
