...
final_df=read.table("/Users/gianlucadamaggio/projects/cattaneo/docs/AC2020_Nanopore_PCR6_ha_pcr_flg/alignment/summary/alignment_summary_p70_qscore-10.txt", header=T,sep='\t')

final_df$qscore = "10"
final_df$replicate = "1"
final_df$experiment = "c15_p70"
...
ggsave(paste(PLOT_PATH,"alignment_coverage_summary-p70.png", sep=""))
...
ggsave(paste(PLOT_PATH,"alignment_genome_start_summary-p70.png", sep=""))
...
ggsave(paste(PLOT_PATH,"alignment_genome_end_summary-p70.png", sep=""))
...
ggsave(paste(PLOT_PATH,"alignment_num_insertions_summary-p70.png", sep=""))
...
final_df_neo=read.table("/Users/gianlucadamaggio/projects/cattaneo/docs/AC2020_Nanopore_PCR6_ha_pcr_flg/alignment/summary/alignment_summary_p70-NEO_qscore-10.txt", header=T,sep='\t')

final_df_neo$qscore = "10"
final_df_neo$replicate = "1"
final_df_neo$experiment = "c15_p70-NEO"
...
ggsave(paste(PLOT_PATH,"alignment_coverage_summary-p70-NEO.png", sep=""))
...
ggsave(paste(PLOT_PATH,"alignment_genome_start_summary-p70-NEO.png", sep=""))
...
ggsave(paste(PLOT_PATH,"alignment_genome_end_summary-p70-NEO.png", sep=""))
...
ggsave(paste(PLOT_PATH,"alignment_num_insertions_summary-p70-NEO.png", sep=""))
...
ggsave(paste(PLOT_PATH,"alignment_num_deletions_summary-p70-NEO.png", sep=""))
...
ggsave(paste(PLOT_PATH,"alignment_identity_summary-p70-NEO.png", sep=""))
...
ggsave(paste(PLOT_PATH,"alignment_accuracy_summary-p70-NEO.png", sep=""))
...
ggsave(paste(PLOT_PATH,"alignment_score_summary-p70-NEO.png", sep=""))
